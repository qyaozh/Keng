...
The `Keng` package is named after Loo-Keng Hua, who made great achievements in mathematics mainly through self-study. Loo-Keng Hua encouraged the novices to show their axe skills at the gate of Ban's house, so the `Keng` package comes.
...
`test_PRE()` computes the *PRE* of the augmented model compared with the compact model. *PRE* is tested using the *F* test.
